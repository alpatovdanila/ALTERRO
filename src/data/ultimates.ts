...
export const ULTIMATES: UltimateDef[] = [
  {
    ...
    name: 'Перегрузка',
    epithet: 'FULL AUTO',
    desc: 'For 10 seconds the weapon screams at 800 RPM. No arena wipe — outmanoeuvre and mow them down. Movement is everything.',
    short: '10 секунд — 800 выстрелов в минуту. Двигайся и коси.',
